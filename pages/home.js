                ...
                <Card style={{ backgroundColor: "#F8F8F8", marginTop: "150px" }}>
                  <CardBody>
                    ...
                    <Grid container direction="row" justify="space-around" alignItems="flex-end">
                      ...
                      <p className={classes.title} style={{ display: "flex" }}><FavoriteBorderOutlinedIcon></FavoriteBorderOutlinedIcon> Save</p>
                    </Grid>
                  </CardBody>
                </Card>
              </GridItem>
                              ...
                              <CardBody>
                                ...
                                <GridContainer>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
                                    <path d="M11.1258 0.0634766C5.03674 0.0634766 0.100616 4.9996 0.100616 11.0886C0.100616 17.1776 5.03674 22.1138 11.1258 22.1138C17.2148 22.1138 22.1509 17.1776 22.1509 11.0886C22.1438 5.00254 17.2118 0.0705646 11.1258 0.0634766Z" fill="#5243C2" fillOpacity="0.103693" />
